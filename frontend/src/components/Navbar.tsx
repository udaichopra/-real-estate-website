...
export default function NavBar() {
    return (
        <nav className=" sticky top-0  z-[4000] w-full flex flex-col md:flex-row justify-between items-center bg-navy-mid/75 shadow-md">
            ...
            />
            <h3 className="pt-3 md:pt-5 text-center text-xl md:text-2xl">Team Chopra Real Estate</h3>
           </Link>
