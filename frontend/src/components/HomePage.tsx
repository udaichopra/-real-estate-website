...
export default function HomePage() {
    return (
        ...
        >
            ...
            <div className="relative z-10 grid min-h-screen w-full place-items-center p-4">
                <div className="text-center">
                    <h1 className="font-display text-gold text-4xl md:text-8xl font-bold pb-5 ">
                        Team Chopra
                    </h1>
        ...
        <section className="bg-navy/75 text-white py-10">
            <div className="max-w-5xl mx-auto px-4">
                ...
                <img src="/teamchopra.jpg" alt="image" className="w-48 h-64 md:w-90 md:h-100 object-cover" />
                <div>
                    <h3 className="font-display text-left text-2xl md:text-3xl font-bold pb-5">
                    About Team Chopra
                </h3>
                <p className="border-l-2 px-4 border-gold font-sans text-lg md:text-xl text-left text-white/55">
        ...
        <section className="bg-navy-mid/75 text-white py-10 ">
            <Listings_Page/>
        </section>
        </div>
